...
class SafetyFinderTest(unittest.TestCase):
    ...
    def test_invalid_input_is_recognized(self):
        self.assertFalse(SafetyFinder._input_is_valid("12"))
        self.assertFalse(SafetyFinder._input_is_valid("a2"))
        self.assertFalse(SafetyFinder._input_is_valid("AA"))
        self.assertFalse(SafetyFinder._input_is_valid("A0"))
        self.assertFalse(SafetyFinder._input_is_valid("A11"))
        self.assertFalse(SafetyFinder._input_is_valid("A1A"))

    def test_all_valid_inputs_are_recognized(self):
        ...
        for agent in agents:
            self.assertTrue(SafetyFinder._input_is_valid(agent))
